...
export class SupporterAdmin extends Modal<
    Events,
    SupporterAdminProperties,
    any
> {
    constructor(props) {
        super(props);
    ...
    makeSupporter = () => {
        ...
        swal({
            ...
            .then(() => {
                post("supporter_center/player/%%", this.props.playerId, {
                    months: num_months,
                })
        ...
        return (
            <div className="Modal SupporterAdmin" ref="modal">
                ...
                {(this.state.loading === false || null) && (
                    <div className="body">
                        <PrettyTransactionInfo
                            transaction={this.state.last_transaction}
                        />
                        <hr />
                                        ...
                                        <table className="method-info">
                                            ...
                                            <tbody>
                                                <tr key={method.id}>
                                                    ...
                                                    <td>
                                                        {method.expiration_month +
                                                            "/" +
                                                            method.expiration_year}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>

                                        {method.purchases.map(
                                            (purchase, idx) => (
                                                <div key={purchase.id}>
