...
export class Player extends React.PureComponent<PlayerProperties, any> {
    ...
    render() {
        ...
        const player_note_indicator = remote_storage.get(`player-notes.${player.id}`) ? <i className={"Player fa fa-clipboard"} onClick={this.openPlayerNotes} data-id={player.id} /> : "";
