    ...
    render() {
        ...
        return (
            <div className="PlayerDetails">
                ...
                {!user.anonymous && (user.id !== this.player_id || null) &&
                ...
                {!user.anonymous && !this.props.noextracontrols && extraActionCallback && extraActionCallback(this.player_id, this.state)}
                { ((user.is_moderator && this.player_id > 0) || null) &&
                    <div className="actions">
                ...
                { ((user.is_superuser && this.player_id > 0) || null) &&
                    <div className="actions">
