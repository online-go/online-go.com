...
> {
    ...
    resolve(player_id) {
        ...
        player_cache
            ...
            .then((player) => {
                this.setState(
                    Object.assign({}, player as any, { resolved: true }),
                );
            })
            .catch((err) => {
    ...
    ban = (_ev) => {
        ban(this.props.playerId)
            .then(this.close_all_modals_and_popovers)
            .catch(errorAlerter);
    };
    shadowban = (_ev) => {
        shadowban(this.props.playerId)
            .then(this.close_all_modals_and_popovers)
            .catch(errorAlerter);
    };
    removeShadowban = (_ev) => {
    ...
    addFriend = () => {
        ...
        this.close_all_modals_and_popovers();
        post("me/friends", { player_id: this.props.playerId })
            .then(ignore)
            .catch(errorAlerter);
    };
    removeFriend = () => {
    ...
    removeAllChats = () => {
        ...
        swal({
            ...
            .then(() =>
                termination_socket.send("chat/remove_all", {
    ...
    render() {
        ...
        const rating =
            ...
            (this.state.ratings
                ? getUserRating(this.state, "overall", 0)
                : null);

        const add_note_label = data.get(
            ...
            <div className="PlayerDetails">
                <div className="details">
                    <div
                        ...
                        style={{
                            backgroundImage:
                                'url("' +
                                icon_size_url(this.state.icon, 64) +
                                '")',
                        }}
                    >
                ...
                {(user.is_moderator || null) && (
                    <div className="actions">
                        ...
                        <button
                            className="xs noshadow reject"
                            onClick={this.removeAllChats}
                        >
                            <i className="fa fa-times-circle" />
                            {pgettext(
                                "Remove all chat lines from this user",
                                "Remove all chats",
                            )}
                        </button>
                    </div>
                ...
                {((user.is_moderator && this.props.playerId > 0) || null) && (
                    <div className="actions">
                        ...
                        <button
                            className="xs noshadow danger"
                            onClick={this.shadowban}
                        >
                ...
                {((user.is_superuser && this.props.playerId > 0) || null) && (
                    <div className="actions">
                        <button
                            className="xs noshadow"
                            onClick={this.openSupporterAdmin}
                        >
...
export function setExtraActionCallback(
    cb: (user_id: number, user: any) => JSX.Element,
) {
