        ...
        if (ts) {
            if (
                ...
                moment(ts).format("YYYY-MM-DD") !==
                    moment(ts_ll).format("YYYY-MM-DD")
            ) {
                show_date = (
                    <div className="date">{moment(ts).format("LL")}</div>
                );
            }
        }
    }
    ...
    return (
        <div
            className={
                ...
                (user.id === data.get("config.user").id
                    ? " self"
                    : ` chat-user-${user.id}`) +
                (mentions ? " mentions" : "")
            }
