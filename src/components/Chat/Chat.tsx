...
export function chat_markup(body, extra_pattern_replacements?: Array<{split: RegExp; pattern: RegExp; replacement: ((m: any, idx: number) => any)}>): Array<JSX.Element> {{{
    let replacements = [
        ...
        {split: /\b(https?:\/\/online-go\.com\/player\/[0-9]+\/?[!#$&-;=-\[\]_a-zA-Z0-9~]*\/?)/gi,
            pattern: /\b(https?:\/\/online-go\.com\/player\/([0-9]+)\/?[!#$&-;=-\[\]_a-zA-Z0-9~]*\/?)/gi,
        ...
        {split: /\b(https?:\/\/online-go\.com\/game\/view\/[0-9]+)\b/gi,
            pattern: /\b(https?:\/\/online-go\.com\/game\/view\/([0-9]+))\b/gi,
        ...
        {split: /\b(https?:\/\/online-go\.com\/review\/view\/[0-9]+)\b/gi,
            pattern: /\b(https?:\/\/online-go\.com\/review\/view\/([0-9]+))\b/gi,
        ...
        {split: /\b(https?:\/\/online-go\.com\/review\/[0-9]+)\b/gi,
            ...
            replacement: (m, idx) => (<Link key={idx} to={`/review/${m[2]}`}>{"review " + m[2]}</Link>)},
        // demos
        {split: /\b(https?:\/\/online-go\.com\/demo\/view\/[0-9]+)\b/gi,
            pattern: /\b(https?:\/\/online-go\.com\/demo\/view\/([0-9]+))\b/gi,
            replacement: (m, idx) => (<Link key={idx} to={`/demo/${m[2]}`}>{"demo " + m[2]}</Link>)},
        {split: /\b(https?:\/\/online-go\.com\/demo\/[0-9]+)\b/gi,
            pattern: /\b(https?:\/\/online-go\.com\/demo\/([0-9]+))\b/gi,
            replacement: (m, idx) => (<Link key={idx} to={`/demo/${m[2]}`}>{"demo " + m[2]}</Link>)},
        // joseki
