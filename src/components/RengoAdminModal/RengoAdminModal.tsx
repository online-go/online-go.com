...
interface RengoAdminModalProperties {
    challenge: any;
...
export class RengoAdminModal extends Modal<Events, RengoAdminModalProperties, {}> {
    constructor(props) {
        super(props);
    }
...
export function openRengoAdminModal(challenge): Promise<any> {

    return new Promise((resolve, reject) => {
        openModal(<RengoAdminModal challenge={challenge} onAccept={resolve} fastDismiss />);
    });
}
