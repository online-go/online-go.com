...
> {
    ...
    render() {
        ...
        let startingPage = 1;
        if (
            !this.props.dontStartOnPlayersPage &&
            ...
            <div className="LadderComponent">
                ...
                <PaginatedTable
                    ...
                    columns={[
                        ...
                        ((full_view && this.state.ladder.player_rank) > 0 ||
                            null) && {
                            header: "",
                            className: "challenge-column",
                            render: (lp) =>
                                ((lp.player.id !== user.id &&
                                    lp.can_challenge) ||
                                    null) &&
                                (lp.can_challenge.challengeable ? (
                                    ...
                                    <span
                                        ...
                                        data-title={canChallengeTooltip(
                                            lp.can_challenge,
                                        )}
                                        onClick={tooltip}
                                        onMouseOver={tooltip}
