...
> {
    ...
    render() {
        ...
        const current_source =
            this.state.selected_filter.source === null
                ? "none"
                : this.state.selected_filter.source;
            ...
            <div className="joseki-variation-filter">
                ...
                <div className="filter-set">
                    <div className="filter-label">
                        {_("Filter by Contributor")}
                    </div>
                    <select
                        value={current_contributor}
                        onChange={this.onContributorChange}
                    >
                        {contributors}
                    </select>
                </div>
