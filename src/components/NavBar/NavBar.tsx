    ...
    render() {
        ...
        return (
            <div
                id="NavBar"
                className={
                    this.state.left_nav_active || this.state.right_nav_active
                        ? "active"
                        : ""
                }
            >
                ...
                <section className="left">
                    ...
                    {user && (
                        <Link to={`/user/view/${user.id}`}>{_("Profile")}</Link>
                    )}
                    {/*
            ...
            */}
                ...
                <div
                    className={
                        ...
                        (this.state.left_nav_active ||
                        this.state.right_nav_active
                            ? "active"
                            : "")
                    }
                ...
                {user && (
                    <div
                        className={
                            "rightnav " +
                            (this.state.right_nav_active ? "active" : "")
                        }
                    >
                ...
                <div
                    className={
                        "leftnav " +
                        (this.state.left_nav_active ? "active" : "")
                    }
                >
                    ...
                    {(!omnisearch_searching || null) && (
                        ...
                        */}
                            ...
                            <li>
                                <a
                                    href="http://forums.online-go.com/"
                                    target="_blank"
                                >
                            ...
                            {(tournament_invites.length ||
                                tournaments.length ||
                                false) && <li className="divider"></li>}
                            {(tournament_invites.length ||
                                tournaments.length ||
                                false) && (
                                <ul>
                                    ...
                                    {group_invites.map((gi, idx) => (
                                        <li key={idx} className="invite">
                                            ...
                                            <i
                                                className="fa fa-check accept clickable"
                                                onClick={() =>
                                                    acceptGroupInvite(gi.id)
                                                }
                                            ></i>
                                            <i
                                                className="fa fa-times reject clickable"
                                                onClick={() =>
                                                    rejectGroupInvite(gi.id)
                                                }
                                            ></i>
                                            <Link to={`/group/${gi.group_id}/`}>
                                                {" "}
                                                {gi.name}
                                            </Link>
                                        </li>
                    ...
                    {(omnisearch_searching || null) && (
                        <div className="OmniSearch-results">
                            {(this.state.omnisearch_sitemap.length || null) && (
                                <div>
                                    <h3>{_("Site")}</h3>
                                    {this.state.omnisearch_sitemap.map(
                                        (e, idx) => (
                                            <div key={idx}>
                                                {e?.[1]?.[0] === "/" ? (
                                                    <Link to={e[1]}>
                            ...
                            {((!this.state.omnisearch_loading &&
                                omnisearch_result_count === 0) ||
                                null) && (
                            ...
                            {(this.state.omnisearch_players.length || null) && (
                                <div>
                                    <h3>{_("Players")}</h3>
                                    {this.state.omnisearch_players.map(
                                        (e, idx) => (
                                            <div key={idx}>
                            ...
                            {(this.state.omnisearch_groups.length || null) && (
                                <div>
                                    <h3>{_("Groups")}</h3>
                                    {this.state.omnisearch_groups.map(
                                        (e, idx) => (
                                            <div key={idx}>
                                                <img src={e.icon} />{" "}
                                                <Link to={`/group/${e.id}`}>
                            ...
                            {(this.state.omnisearch_tournaments.length ||
                                ...
                                <div>
                                    <h3>{_("Tournaments")}</h3>
                                    {this.state.omnisearch_tournaments.map(
                                        (e, idx) => (
                                            <div key={idx}>
                                                <img src={e.icon} />{" "}
                                                <Link
...
omnisearch_sitemap[_("Developers")] = [
    _("Developers & API Access"),
    "/developer",
];
omnisearch_sitemap[_("API Access")] = [
    _("Developers & API Access"),
    "/developer",
];
...
omnisearch_sitemap[_("Learn to play Go")] = [
    _("Learn to play Go"),
    "/learn-to-play-go",
];
omnisearch_sitemap[_("Learn")] = [_("Learn to play Go"), "/learn-to-play-go"];
omnisearch_sitemap[_("Tutorial")] = [
    _("Learn to play Go"),
    "/learn-to-play-go",
];
omnisearch_sitemap[_("How to play go")] = [
    _("Learn to play Go"),
    "/learn-to-play-go",
];
omnisearch_sitemap[_("FAQ")] = [
    _("F.A.Q."),
    "https://forums.online-go.com/c/faq",
];
omnisearch_sitemap[_("F.A.Q.")] = [
    _("F.A.Q."),
    "https://forums.online-go.com/c/faq",
];
omnisearch_sitemap[_("Help")] = [
    _("F.A.Q."),
    "https://forums.online-go.com/c/faq",
];
omnisearch_sitemap[_("Changelog")] = [_("Changelog"), "docs/changelog"];
omnisearch_sitemap[_("About")] = [_("About"), "/docs/about"];
omnisearch_sitemap[_("Refund Policy")] = [
    _("Refund Policy"),
    "/docs/refund-policy",
];
omnisearch_sitemap[_("Terms of Service")] = [
    _("Terms of Service"),
    "/docs/terms-of-service",
];
omnisearch_sitemap["ToS"] = [_("Terms of Service"), "/docs/terms-of-service"];
omnisearch_sitemap[_("Privacy Policy")] = [
    _("Privacy Policy"),
    "/docs/privacy-policy",
];
