...
export function getAutomatchSettings(
    ...
    switch (speed) {
        ...
        case "correspondence":
            return dup(
                data.get("automatch.correspondence", default_correspondence),
            );
    }
}
...
> {
    constructor(props) {
        ...
        this.state = {
            ...
            correspondence_settings: data.get(
    ...
    toggleSize(size) {
        ...
        if (settings.size_options.indexOf(size) >= 0) {
            settings.size_options = settings.size_options.filter(
                (x) => x !== size,
            );
        } else {
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ConditionSelect
                                            value={
                                                settings.time_control.condition
                                            }
                                            onChange={
                                                this.setTimeControlCondition
                                            }
                                        />
                                        {settings.time_control.condition ===
                                        "no-preference" ? (
                                            <i>
                                                {tab === "correspondence"
                                                    ? _(
                                                          "Default is to use Fischer",
                                                      )
                                                    : _(
                                                          "Default is to use Byo-Yomi",
                                                      )}
                                            </i>
                                        ) : (
                                            <select
                                                value={
                                                    settings.time_control.value
                                                        .system
                                                }
                                                onChange={
                                                    this.setTimeControlSystem
                                                }
                                            >
                                                <option value="byoyomi">
                                                    {_("Byo-Yomi")}
                                                </option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        />
                                        {settings.rules.condition ===
                                        "no-preference" ? (
                                            <i>
                                                {_(
                                                    "Default is to use Japanese rules",
                                                )}
                                            </i>
                                        ) : (
                                            <select
