...
export class IncidentReportTracker extends React.PureComponent<
    {},
    IncidentReportTrackerState
> {
                    ...
                    emitNotification(
                        ...
                        () => {
                            if (report.reported_game) {
                                browserHistory.push(
                                    `/game/${report.reported_game}`,
                                );
                            } else if (report.reported_review) {
                                browserHistory.push(
                                    `/review/${report.reported_review}`,
                                );
                            } else if (report.reported_user) {
                                browserHistory.push(
                                    `/user/view/${report.reported_user.id}`,
                                );
                            }
                        },
                    );
            ...
            <div className="IncidentReportTracker">
                ...
                >
                    ...
                    <span className="count">
                        {this.state.normal_ct || this.state.sandbag_ct}
                    </span>
                </div>
                            ...
                            {this.state.reports.map((report, idx) => (
                                <div className="incident" key={report.id}>
                                    <div className="report-header">
                                        ...
                                        {report.moderator ? (
                                            <Player
                                                user={report.moderator}
                                                icon
                                            />
                                        ) : user.is_moderator ? (
                                            <button
                                                className="primary xs"
                                                onClick={report.claim}
                                            >
                                                {_("Claim")}
                                            </button>
                                        ) : (
                                    ...
                                    <div className="spread">
                                        ...
                                        {(report.reported_game || null) && (
                                            <span>
                                                {_("Game")}:{" "}
                                                <Link
                                                    to={`/game/view/${report.reported_game}`}
                                                >
                                        ...
                                        {(report.reported_review || null) && (
                                            <span>
                                                {_("Review")}:{" "}
                                                <Link
                                                    to={`/review/${report.reported_review}`}
                                                >
