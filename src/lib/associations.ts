...
export let associations:Array<IAssociation> = [
    {country: "ar", name: "Asociación Argentina de Go"},
    {country: "am", name: "Armenian Draughts and Go Federation "},
    {country: "au", name: "Australian Go Association"},
    ...
    {country: "ca", name: "Canadian Go Association "},
    ...
    {country: "eu", name: "European Go Federation"},
    {country: "fi", name: "Suomen Go-liitto ry "},
    {country: "fr", name: "French Go Federation"},
    ...
    {country: "ua", name: "Ukrainian Go Federation "},
    {country: "gb", name: "British Go Association"},
    {country: "us", name: "American Go Association"},
