...
export const associations: Array<IAssociation> = [
    ...
    {
        country: "az",
        name: "Azerbaijan GalaGAPI Federation (Azərbaycan Qalaqapı Federasiyası)",
    },
    ...
    {
        country: "fr",
        name: "Fédération Française de Go (French Go Federation)",
        acronym: "FFG",
    },
