...
type CallbackTable<T> = {
    [K in Extract<keyof T, string>]?: { [serial: number]: Callback<T, K> };
};
type Callback<T, K extends Extract<keyof T, string>> = (
    channel: K,
    item: T[K],
) => void;
...
export class Publisher<T> {
    ...
    constructor() {
        ...
        this.Subscriber = class Subscriber<
            K extends Extract<keyof T, string>,
        > extends AbstractSubscriber<T, K> {
