...
export class Overview extends React.Component<{}, any> {
    ...
    constructor(props) {
        ...
        try {
            if (
                ...
                Date.now() - preferences.get("translation-dialog-dismissed") >
                    14 * 86400 * 1000
            ) {
        ...
        this.state = {
            ...
            resolved: false,
            boards_to_move_on: Object.keys(
                notification_manager.boards_to_move_on,
            ).length,
        };
    }
    ...
    setTitle() {
        const count =
            this.state.boards_to_move_on > 0
                ? `(${this.state.boards_to_move_on}) `
                : "";
            ...
            <div id="Overview-Container">
                ...
                <div id="Overview">
                    <div className="left">
                        ...
                        {((this.state.resolved &&
                            this.state.overview.active_games.length) ||
                            null) && (
                        ...
                        {((this.state.resolved &&
                            this.state.overview.active_games.length === 0) ||
                            null) && (
                        ...
                        <div className="overview-categories">
                            {this.state.show_translation_dialog && (
                                <Card className="translation-dialog">
                                    <FabX
                                        onClick={this.dismissTranslationDialog}
                                    />
                                    ...
                                    <button
                                        ...
                                        onClick={
                                            this.neverShowTranslationDialog
                                        }
                                    >
                ...
                {this.state.invitations.map((invite) => (
                    <div className="invite" key={invite.id}>
                        <i
                            ...
                            onClick={this.rejectInvite.bind(this, invite)}
                        />
                        <i
                            className="fa fa-check"
                            onClick={this.acceptInvite.bind(this, invite)}
                        />
                        <Link
                            key={invite.group.id}
                            to={`/group/${invite.group.id}`}
                        >
