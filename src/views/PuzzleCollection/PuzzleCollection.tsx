...
export function PuzzleCollection({
    ...
    const [color_transform_enabled, setColorTransformEnabled] =
        React.useState(false);
    const [position_transform_enabled, setPositionTransformEnabled] =
        React.useState(false);
    ...
    React.useEffect(() => {
        get(`puzzles/collections/${collection_id}`)
            .then((collection) => {
                ...
                setPositionTransformEnabled(
                    collection["position_transform_enabled"],
                );
                ...
                <dl className="horizontal">
                    ...
                    <dd>
                        <input
                            ...
                            onChange={(ev) =>
                                setColorTransformEnabled(ev.target.checked)
                            }
                        />
                    </dd>
                ...
                del(`puzzles/collections/${collection_id}`)
                    .then(() => {
                        window.location.pathname =
                            "/puzzle-collections/" + data.get("user").id;
                    })
                    .catch(errorAlerter);
            })
            .catch(ignore);
