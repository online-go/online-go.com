...
export class Styling extends React.PureComponent<{}, any> {
    ...
    constructor(props) {
        ...
        this.state = {
            star_ratings: [
                0, 0.1, 0.5, 1.0, 1.1, 1.6, 2.0, 2.7, 3.0, 3.8, 4.1, 4.7, 5, 6,
            ],
                ...
                <div className="row">
                    <div className="col-xs-5">
                        ...
                        <Steps
                            ...
                            onChange={(idx) =>
                                this.setState({ selected_step: idx })
                            }
                        >
                            <span title="first" />
                            <span />
                        ...
                        <Card>
                            ...
                            <div>
                                {this.state.autocompleted_player && (
                                    <Player
                                        icon
                                        user={this.state.autocompleted_player}
                                    />
                                )}
                            </div>

                            <GroupAutocomplete
                                onComplete={this.updateAutocompletedGroup}
                            />
                            <div>
                                {this.state.autocompleted_group && (
                                    <div>
                                        {this.state.autocompleted_group.name}
                                    </div>
                                )}
                            </div>
                        </Card>
                                ...
                                <Card>
                                    {this.state.star_ratings.map((v, idx) => (
                                        <div key={idx}>
                                            <StarRating
                                                value={v}
                                                onChange={this.setStarRating.bind(
                                                    this,
                                                    idx,
                                                )}
                                            />{" "}
