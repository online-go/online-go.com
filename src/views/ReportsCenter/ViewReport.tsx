...
export function ViewReport({
    ...
    const handleOpenAnnulQueueModal = async () => {
        try {
            ...
            // Generate condensed criteria string
            const criteria = `M${criteriaData.months_threshold}B${criteriaData.games_before}A${criteriaData.games_after}S${criteriaData.smr_threshold}D${criteriaData.smr_delta}R${criteriaData.blur_threshold}G${criteriaData.game_count_threshold}`;
            setCriteriaString(criteria);
        } catch (error) {
