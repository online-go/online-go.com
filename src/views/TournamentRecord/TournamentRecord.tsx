...
> {
    ...
    constructor(props) {
        ...
        const tournament_record_id =
            parseInt(this.props.match.params.tournament_record_id) || 0;
    ...
    abort_requests() {
        abort_requests_in_flight(
            `tournament_records/${this.state.tournament_record_id}`,
        );
    }
    ...
    addPlayer = (ev) => {
        ...
        post(
            `tournament_records/${this.state.tournament_record_id}/players/`,
            new_player,
        )
            .then((res) => {
    ...
    recordGame(round: Round) {
        createDemoBoard(
            this.state.players,
            this.state.tournament_record_id,
            round.id,
        );
    }
