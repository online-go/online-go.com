...
> {
    ...
    UNSAFE_componentWillReceiveProps(next_props) {
        ...
        if (
            ...
            next_props.match.params.player_id
        ) {
        ...
        if (next_props.match.params.collection_id) {
            if (
                ...
                next_props.match.params.collection_id
            ) {
                update.collection_id = parseInt(
                    next_props.match.params.collection_id,
                );
                update.games_checked = {};
            }
            ...
            .then((library) => {
                ...
                for (const id in collections) {
                    ...
                    collections[id].parent =
                        collections[collections[id].parent_id];
                ...
                for (const collection_id in collections) {
                    ...
                    collection.collections.sort((a, b) =>
    ...
    uploadSGFs = (files) => {
        if (
            parseInt(this.props.match.params.player_id) === data.get("user").id
        ) {
            ...
            console.log(
                "Not uploading selected files since we're not on our own library page",
            );
        }
    };
    ...
    setCollection(collection_id) {
        browserHistory.push(
            `/library/${this.state.player_id}/${collection_id}`,
        );
    }
