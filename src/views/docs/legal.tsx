...
<div className="container">
  <div className="column well">
    ...
    <div className="legal-paragraph">
        ...
        <div className="legal-paragraph">
        We reserve the right to, at our sole discretion, delete or freeze
        your account and/or delete some, none, or all of the Content you've
        posted, generated, or otherwise stored on Online-Go.com.
        </div>
    </div>
    ...
    that enable users to enjoy the game of Go and interact with other users (the “Service”).
    ...
    under your password or account. Online-Go.com cannot and will not be liable
    for any loss or damage arising from your failure to protect your
    account.
    </div>

    <div className="legal-paragraph">
    You acknowledge, consent and agree that Online-Go.com may access, preserve
    ...
    Online-Go.com, its users and the public.
    </div>
    ...
    messages, game history, or other Content or communications maintained
    or transmitted by the Service.  You acknowledge that Online-Go.com reserves
    the right to remove, disable, or reclaim accounts that are inactive for an extended period
    of time. You further acknowledge that Online-Go.com reserves the right to
    modify these general practices and limits from time to time.


    <h2>Account Termination</h2>
    You agree that Online-Go.com may, under certain circumstances and without
    prior notice, immediately terminate your Online-Go.com account and access to
    the Service.  Cause for such termination shall include, but not be
    ...
    government agencies, (c) a request by you, (d) unexpected technical or
    security issues or problems, (e) extended periods of inactivity, (f)
    engagement by you in fraudulent or illegal activities, and/or (g)
    nonpayment of any fees owed by you in connection with the Services.
    Termination of your Online-Go.com account includes the removal of access to
    some or all offerings within the Service, removal of private and public
    "profile information", and at our sole discretion, removal of
    messages, game history, and other Content stored by Online-Go.com.  Further,
    you agree that all terminations for cause shall be made in Online-Go.com's
    ...
    the accuracy, integrity, quality, or legality of such Content. By using the
    Service, you understand that you may unintentionally be exposed to Content
    that is offensive, indecent, or objectionable. Under no circumstances
    will Online-Go.com be liable in any way for any Content, including, but not limited
    ...
    <div className="legal-paragraph">
    You acknowledge and understand that Online-Go.com reserves the right to move or remove
    any content on Online-Go.com Services.
    </div>

    <div className="legal-paragraph">
    Online-Go.com does not claim ownership of any Content you submit or otherwise
    make available through the Service.  However, by submitting Content to
    the service you grant Online-Go.com the following worldwide, royalty-free,
    and non-exclusive license: that any Content you submit or make
    available on or through the Service, the perpetual, irrevocable, and
    fully sublicensable license to use, distribute, reproduce, modify,
    adapt, publish, translate, perform, and display such Content (in whole
    ...
    Online-Go.com may place various forms of advertisements throughout the site
    and other communications. Furthermore, you agree that Online-Go.com shall not
    be responsible or liable for any loss or damage of any sort incurred by
    you as a result of the presence of such advertisements on Online-Go.com
    services or your subsequent dealings with advertisers.
    </div>
    ...
    World Wide Web sites or resources. Because Online-Go.com has no control over
    such sites and resources, you acknowledge and agree that Online-Go.com is
    ...
    Online-Go.com shall not be responsible or liable, directly or indirectly,
    ...
    you and Online-Go.com with respect to the Service. You also may be subject to
    additional terms and conditions that may apply when you use or purchase certain
    other Online-Go.com services, affiliate services, third-party content or
    third-party software. The ToS and the relationship between you and Online-Go.com
    shall be governed by the laws of the State of North Carolina without regard to
    its conflict of law provisions. You and Online-Go.com agree to submit to the
    personal and exclusive jurisdiction of the courts located within the State of
    North Carolina. The failure of Online-Go.com to exercise or enforce any right or
    ...
    <ol>
        ...
        ON AN "AS IS" AND "AS AVAILABLE" BASIS. ONLINE-GO.COM AND ITS SUBSIDIARIES,
        ...
        THE SERVICE IS ACCESSED AT YOUR OWN DISCRETION AND RISK, AND YOU
        ...
        FROM ONLINE-GO.COM OR THROUGH OR FROM THE SERVICE SHALL CREATE ANY
        ...
        FAMILY, HAVE AN EPILEPTIC CONDITION, CONSULT YOUR PHYSICIAN PRIOR
        TO USING THE SERVICE. IMMEDIATELY DISCONTINUE USE OF THE SERVICE
        AND CONSULT YOUR PHYSICIAN IF YOU EXPERIENCE ANY OF THE FOLLOWING
        SYMPTOMS WHILE USING THE SERVICE: DIZZINESS, ALTERED VISION, EYE OR
    ...
    YOU HEREBY ACKNOWLEDGE THAT THIS SECTION SHALL APPLY TO ALL CONTENTS ON
    ALL SERVERS AND ALL SERVICES. SOME JURISDICTIONS DO NOT ALLOW THE
    LIMITATION OR EXCLUSION OF LIABILITY FOR INCIDENTAL OR CONSEQUENTIAL
    DAMAGES YOU AGREE THAT IN THOSE JURISDICTIONS, ONLINE-GO.COM'S LIABILITY WILL
    ...
    nevertheless remain in full force and effect. Online-Go.com and the User
    agree to renegotiate any term held invalid and to be bound by
    mutually agreed substitute provision.

    <h2>Changes to the Terms of Service</h2>

    We may revise the Terms of Service from time to time. The most current
    version of the policy will govern our use of your information and will
    always be at <a
        href="http://online-go.com/docs/terms-of-service">http://online-go.com/docs/terms-of-service</a>.
    If we make a change to the Terms of Service that, in our sole
    discretion, is material, we will notify you via an email to the email
    address associated with your account (if one is provided and verified),
    or by prominently displaying a Terms of Service notice. By continuing
    to access or use the Services after those changes become effective, you
  ...
  <div className="column well">
    <div className="legal-paragraph">
        <h1 style={{textDecoration: "underline"}}>Short Version</h1>
            ...
            etc...) If you provide us with additional information for your
            public profile, then we will make that
            information available on our website (ie on your profile page),
            search engines (so people can search for your name for
            example), and other media.
    </div>
    ...
    information through our various websites, APIs, applications, emails,
    and other electronic means (the "Services" or "Online-Go.com"). For example, you
    send us information when you use Online-Go.com from our website, access Online-Go.com
    from an application on your smartphone or tablet, send us emails, or
    use embedded game boards on other websites or applications. When using
    ...
    described in this Privacy Policy. Irrespective of which country you
    reside in or supply information from, you authorize Online-Go.com to use your
    information in the United States and any other country where Online-Go.com
    operates.
    </div>

    <div className="legal-paragraph">
    If you have any questions or comments about this Privacy Policy, please
    contact us at <a href="privacy@online-go.com">privacy@online-go.com</a>
    </div>
    ...
    associations to other players ("Friends"). We may make some or all of
    your additional information available on our website (under your
    profile, user badges, or other places). We may also use your additional
    information to help others find your account.  If you email us, we may
    keep your message, email address and contact information to respond to
    your request. If you connect your Online-Go.com account to another service, such
    as Google or Facebook, the other service may send us your registration
    or profile information on that service and other information that you
    authorize. Providing the additional information described in this
    section is entirely optional.
    </div>


    <h5>Cookies:</h5> Like many websites we use cookies to
    maintain session information as a means to persist login state and to
    preserve some settings for your convenience. Most Internet browsers
    automatically accept cookies. All modern internet browsers allow you to
    disable cookies by changing its settings, however some of our Services
    will not function properly if you do this.


    <h5>Log Data:</h5> Our servers may record information ("Log
    ...
    <div className="legal-paragraph">
    <h5>Your Consent:</h5> We may share or disclose your information at
    your direction, such as when you authorize a third-party web client or
    application to access your Online-Go.com account.
    </div>
    ...
    technical issues. However, nothing in this Privacy Policy is intended
    to limit any legal defenses or objections that you may have to a third
    ...
    non-private, aggregated or otherwise non-personal information, such as
    your public user profile information, game information (both ongoing
    and historical), friends, public and game chats, and forum posts.
    </div>
    ...
    and account settings to access or modify the personal information associated
    with your Online-Go.com account.


    <h3>Our Policy Towards Children</h3>

    Our Services are not directed to persons under 13. If you become aware
    that your child has provided us with profile information without your
    consent, please contact us at <a
        href="mailto:privacy@online-go.com">privacy@online-go.com</a>. We do not
    ...
    version of the policy will govern our use of your information and will
    always be at <a
        href="http://online-go.com/docs/privacy-policy">http://online-go.com/docs/privacy-policy</a>.
    ...
    associated with your account (if one is provided and verified), or by
    prominently displaying a Privacy Update notice. By continuing to access
    or use the Services after those changes become effective, you agree to
...
<div className="container">
    <div className="column well">
        ...
        <div className="legal-paragraph">
            Supporter account subscriptions may be canceled at any time. Refunds
            for the last payment will be given upon request. All requests must
            be received within 30 days of the last payment.
        </div>
    </div>
</div>
);
