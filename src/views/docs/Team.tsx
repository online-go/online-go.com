...
export class Team extends React.PureComponent<{}, any> {
    ...
    UNSAFE_componentWillMount() {
        get(
            "https://api.github.com/repos/online-go/online-go.com/contributors?per_page=100",
        )
            .then((list) => {
                ...
                <div className="row" style={{ paddingLeft: "2em" }}>
                    ...
                    <div className="col-sm-6">
                        ...
                        <div>
                            ...
                            <span className="name">
                                <a href="https://online-go.com/user/view/740904/A-i">
                                    Aiden
                                </a>
                            </span>
                        </div>
                        ...
                        <h3>
                            {pgettext("Sound and graphics files", "Assets")}
                        </h3>
                        <div>
                            <span className="flags">
                                <Flag country="gb" />
                        ...
                        <div>
                            ...
                            <span className="name">
                                <a href="https://freesound.org/people/rhodesmas/">
                                    Andy Rhode
                                </a>
                            </span>
                        ...
                        <div>
                            ...
                            <span className="name">
                                <a href="https://freesound.org/people/tim.kahn/">
                                    Amy Gedgaudas
                                </a>
                            </span>
                            <span className="description">
                        ...
                        <div>
                            ...
                            <span className="name">
                                <a href="https://freesound.org/people/acclivity/">
                                    acclivity
                                </a>
                            </span>
                            <span className="description">- Effects</span>
                        ...
                        <div>
                            ...
                            <span className="name">
                                <a href="https://freesound.org/people/JonnyRuss01/">
                                    JonnyRuss01
                                </a>
                            </span>
                            <span className="description">- Effects</span>
                        ...
                        <div>
                            ...
                            <span className="name">
                                <a href="https://online-go.com/player/1/anoek">
                                    Akita Noek
                                </a>
                            </span>
                        </div>
