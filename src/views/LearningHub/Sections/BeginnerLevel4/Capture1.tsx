...
class Page01 extends LearningPage {
    ...
    text() {
        return _(
            "In encircling, you surround your opponent's stones, like with a ladder. Along the way, you sacrifice one or more stones, but you continue to move atari. Finally, you capture the entire group. White to play. Capture as many black stones as possible.",
        );
    }
    config(): GobanConfig {
        return {
