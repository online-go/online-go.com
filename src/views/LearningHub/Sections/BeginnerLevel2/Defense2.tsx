...
export class BL2Defense2 extends LearningHubSection {
    ...
    static section(): string {
        return "bl2-defense-2";
    }
    static title(): string {
        return pgettext("Tutorial section name on learning defend territory", "Defense 2");
    }
...
class Page01 extends LearningPage {
    ...
    text() {
        return _("White to play. Black has played 1. Defend White's territory.");
    }
    config(): GobanConfig {
        return {
            width: 19,
