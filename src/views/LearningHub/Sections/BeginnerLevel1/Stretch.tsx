...
export class BL1Stretch extends LearningHubSection {
    ...
    static subtext(): string {
        return pgettext(
            "Tutorial section subtext on learning on stretch",
...
class Page02 extends LearningPage {
    ...
    text() {
        return _("White to play. Stretch the best way.");
    }
    config(): GobanConfig {
        return {
            width: 19,
...
class Page05 extends LearningPage {
    ...
    config(): GobanConfig {
        return {
            ...
            bounds: { top: 10, left: 0, bottom: 18, right: 8 },
            initial_state: {
                black: "bpcpbqdqeqfqhr",
                white: "clcmdpcqbrcrdr",
            },
