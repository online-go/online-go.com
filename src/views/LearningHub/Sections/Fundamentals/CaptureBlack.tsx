...
export class CaptureBlack extends LearningHubSection {
    ...
    static section(): string {
        return "exercise_1_5_4";
    }
    static title(): string {
        return pgettext("Tutorial section name on learning Exercise_1_5_4", "Capture Black");
    }
    static subtext(): string {
        return pgettext(
            "Tutorial section subtext on learning on Exercise_1_5_4",
            "Capture black stones",
        );
    }
}
