...
export class BL3Joseki4 extends LearningHubSection {
    ...
    static title(): string {
        return pgettext("Tutorial section name on learning deviation 3", "Joseki");
    }
    static subtext(): string {
        return pgettext("Tutorial section subtext on learning on deviation 3", "Joseki deviations");
    }
}
...
class Page11 extends LearningPage {
    ...
    config(): GobanConfig {
        return {
            ...
            /* cSpell:disable */
            initial_state: {
                black: "bmcmcncodpdqer",
                white: "bnbocpcqcrdr",
            },
            marks: { A: "am", B: "ap", C: "eq", 1: "bm" },
