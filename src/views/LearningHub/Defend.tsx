...
export class Defend extends LearningHubSection {
    ...
    static title(): string {
        return pgettext("Tutorial section name on learning how to defend", "Defend!");
    }
    static subtext(): string {
        return pgettext("Tutorial section subtext on learning how to defend", "Two eyes or death");
    }
}
...
class Page1 extends LearningPage {
    ...
    config(): PuzzleConfig {
        return {
            ...
            move_tree: this.makePuzzleMoveTree(["b1"], ["a1b1c1b1", "c1b1a1b1"]),
        };
    }
}
