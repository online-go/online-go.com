...
export class Puzzle extends React.Component<PuzzleProperties, PuzzleState> {
    ...
    UNSAFE_componentWillReceiveProps(next_props) {
        if (
            ...
            next_props.match.params.puzzle_id
        ) {
            this.reinitialize();
            this.setState({
                loaded: false,
    ...
    recenterGoban() {
        ...
        $(this.refs.goban_container).css({
            top:
                Math.ceil(this.refs.goban_container.offsetHeight - m.height) /
                2,
            left:
                Math.ceil(this.refs.goban_container.offsetWidth - m.width) / 2,
        });
    }
    reinitialize() {
        if (this.goban) {
    ...
    fetchPuzzle(puzzleId: number) {
        this.editor.fetchPuzzle(puzzleId, (state, editing) => {
            ...
            data.set(
                `puzzle.collection.${state.collection.id}.last-visited`,
                state.id,
            );
    ...
    ratePuzzle = (value) => {
        put("puzzles/%%/rate", +this.props.match.params.puzzle_id, {
            rating: value,
        })
            .then(ignore)
            .catch(errorAlerter);
    ...
    save = () => {
        ...
        puzzle.puzzle_opponent_move_mode =
            this.state.puzzle.puzzle_opponent_move_mode;
        puzzle.puzzle_player_move_mode =
            this.state.puzzle.puzzle_player_move_mode;

        if (parseInt(this.props.match.params.puzzle_id)) {
            /* save */
            put("puzzles/%%", +this.props.match.params.puzzle_id, {
                puzzle: puzzle,
            })
                .then((res) => {
            ...
            post("puzzles/", { puzzle: puzzle })
                .then((res) => {
                    browserHistory.push(
                        `/puzzle-collection/${puzzle.puzzle_collection}`,
                    );
                })
                .catch(errorAlerter);
        }
    ...
    openPuzzleSettings = (ev) => {
        ...
        const randomize_transform = preferences.get(
    ...
    setCorrectAnswer = () => {
        ...
        this.goban.engine.cur_move.correct_answer =
            !this.goban.engine.cur_move.correct_answer;
        this.goban.move_tree_redraw();
        this.forceUpdate();
    };
    setIncorrectAnswer = () => {
        ...
        this.goban.engine.cur_move.wrong_answer =
            !this.goban.engine.cur_move.wrong_answer;
        this.goban.move_tree_redraw();
        this.forceUpdate();
    };
    ...
    showHint = () => {
        ...
        if (this.state.hintsOn) {
            ...
            const branches =
                this.goban.engine.cur_move.findBranchesWithCorrectAnswer();
    ...
    renderPlay() {
        ...
        if (
            this.goban.engine.move_tree.findBranchesWithCorrectAnswer()
                .length === 0
        ) {
        ...
        const have_content: boolean =
            ...
            (!goban.engine.cur_move.parent &&
                !!goban.engine.puzzle_description);
        return (
            <div
                className={`Puzzle ${view_mode} ${squashed ? "squashed" : ""}`}
            >
            ...
            <dl className="horizontal">
                ...
                <dd>
                    <select
                        ...
                        id="selected_puzzle"
                    >
                        {this.state.puzzle_collection_summary.map(
                            (puzzle, idx) => (
            ...
            <div className="btn-container">
                <div className="btn-group">
                    <button
                        ...
                        disabled={
                            !this.state.collection.position_transform_enabled
                        }
                    ...
                    <button
                        ...
                        disabled={
                            !this.state.collection.color_transform_enabled
                        }
                    ...
                    <button
                        ...
                        className={
                            this.state.label_positioning === "all"
                                ? "active"
                                : ""
                        }
    ...
    frag_undo_reset_buttons() {
        ...
        return (
            <div
                style={{
                    visibility: goban.engine.cur_move.parent
                        ? "visible"
                        : "hidden",
                }}
            >
    ...
    frag_puzzle_content() {
        ...
        for (
            let i = 0;
            i < this.state.puzzle_collection_summary.length - 1;
            ++i
        ) {
            ...
            <div className="puzzle-node-content">
                ...
                {(this.state.show_wrong || null) && (
                    <div className="incorrect">
                        <i className="fa fa-times-circle-o reject-text"></i>{" "}
                        {_("Incorrect")}
                    </div>
                )}
    ...
    renderEdit() {
        ...
        return (
            ...
            >
                ...
                <KBShortcut
                    shortcut="right"
                    action={this.navigation.nav_next}
                />
                <KBShortcut
                    shortcut="page-up"
                    action={this.navigation.nav_prev_10}
                />
                <KBShortcut
                    shortcut="page-down"
                    action={this.navigation.nav_next_10}
                />
                <KBShortcut
                    shortcut="home"
                    action={this.navigation.nav_first}
                />
              ...
              */}
                ...
                <div className={"right-col"}>
                    <div className="btn-group">
                        <button
                            className={
                                this.state.edit_step === "setup" ? "active" : ""
                            }
                        ...
                        <button
                            className={
                                this.state.edit_step === "moves" ? "active" : ""
                            }
                        ...
                        <div>
                            <div className="space-around padded">
                                ...
                                >
                                    ...
                                    {this.state.puzzle_collections.map(
                                        (e, idx) => (
                            ...
                            <div className="padded">
                                <div className="space-around">
                                    ...
                                    >
                                        ...
                                        <option value="best_move">
                                            {_("Best Move")}
                                        </option>
                                        <option value="endgame">
                                            {_("End Game")}
                                        </option>
                            ...
                            <dl className="horizontal">
                                ...
                                <dd>
                                    <div className="btn-group">
                                        <button
                                            onClick={this.setSetupColor.bind(
                                                this,
                                                "black",
                                            )}
                                            className={
                                                this.state.setup_color ===
                                                "black"
                                                    ? "active"
                                                    : ""
                                            }
                            ...
                            <div className="space-around">
                                {(this.props.match.params.puzzle_id !== "new" ||
                                    null) && (
                                    <button
                                        className="reject"
                    ...
                    {(this.state.edit_step === "moves" || null) && (
                        <div>
                            <div className="padded space-between">
                                <button
                                    onClick={
                                        this.set_analyze_tool.stone_alternate
                                    }
                                    className={
                                        "stone-button " +
                                        (this.state.analyze_tool === "stone" &&
                                        this.state.analyze_subtool !==
                                            "black" &&
                                ...
                                <div className="btn-group">
                                    <button
                                        onClick={
                                            this.set_analyze_tool.label_letters
                                        }
                                        className={
                                            this.state.analyze_tool ===
                                                "label" &&
                                            this.state.analyze_subtool ===
                                                "letters"
                                                ? "active"
                                    ...
                                    <button
                                        onClick={
                                            this.set_analyze_tool.label_numbers
                                        }
                                        className={
                                            this.state.analyze_tool ===
                                                "label" &&
                                    ...
                                    <button
                                        onClick={
                                            this.set_analyze_tool.label_triangle
                                        }
                                        className={
                                            this.state.analyze_tool ===
                                                "label" &&
                                    ...
                                    <button
                                        onClick={
                                            this.set_analyze_tool.label_square
                                        }
                                        className={
                                            this.state.analyze_tool ===
                                                "label" &&
                                    ...
                                    <button
                                        onClick={
                                            this.set_analyze_tool.label_circle
                                        }
                                        className={
                                            this.state.analyze_tool ===
                                                "label" &&
                                    ...
                                    <button
                                        onClick={
                                            this.set_analyze_tool.label_cross
                                        }
                                        className={
                                            this.state.analyze_tool ===
                                                "label" &&
                                ...
                                >
                                    {
                                        _(
                                            "Correct answer",
                                        ) /* translators: Correct puzzle move */
                                    }
                                </button>
                            ...
                            <div className="space-around">
                                <button onClick={this.setSetupStep}>
                                    &larr; {_("Setup")}
                                </button>
