...
export class PuzzleEditor {
    ...
    createPuzzleCollection(puzzle: any, name: string): Promise<any> {
        ...
        return post("puzzles/collections/", {
            ...
            .then((res) => {
                postResult = res;
                return get("puzzles/collections/", {
                    page_size: 100,
            ...
            .then((collections) => {
                return {
                    puzzle: Object.assign({}, puzzle, {
                        puzzle_collection: postResult.id,
                    }),
    ...
    fetchPuzzle(
        puzzle_id: number,
        callback: (state: any, editing: boolean) => void,
    ) {
        ...
        Promise.all([
            ...
            .then((arr) => {
                ...
                let randomize_color = preferences.get(
                ...
                this.transform.settings.transform_color =
                    randomize_color && Math.random() > 0.5;
                this.transform.settings.transform_h =
                    randomize_transform && Math.random() > 0.5;
                this.transform.settings.transform_v =
                    randomize_transform && Math.random() > 0.5;
                this.transform.settings.transform_x =
                    randomize_transform && Math.random() > 0.5;
    ...
    reset(
        ...
        const opts: GobanCanvasConfig = Object.assign(
            {
                ...
                draw_top_labels:
                    label_position === "all" ||
                    label_position.indexOf("top") >= 0,
                draw_left_labels:
                    label_position === "all" ||
                    label_position.indexOf("left") >= 0,
                draw_right_labels:
                    label_position === "all" ||
        ...
        if (editing) {
            ...
            opts.move_tree_container = document.getElementById(
                "move-tree-container",
            );
        }
