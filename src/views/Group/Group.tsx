...
export class Group extends React.PureComponent<GroupProperties, GroupState> {
        ...
        swal({
            ...
            .then((name) => {
                ...
                post("tournament_records/", {
                    ...
                    .then((res) => {
                        browserHistory.push(
                            `/tournament-record/${res.id}/${slugify(name)}`,
                        );
                    })
                    .catch(errorAlerter);
            })
    ...
    setShortDescription = (ev) => {
        this.setState({
            group: Object.assign({}, this.state.group, {
                short_description: ev.target.value,
            }),
        });
    };
    setDescription = (ev) => {
    ...
    setHideDetails = (ev) => {
        this.setState({
            group: Object.assign({}, this.state.group, {
                hide_details: ev.target.checked,
            }),
        });
    };
    setDisableInvitationRequests = (ev) => {
        this.setState({
            group: Object.assign({}, this.state.group, {
                require_invitation: ev.target.checked,
            }),
        });
    };
    setNewNewsTitle = (ev) => {
    ...
    updateNewsContent = (ev) => {
        this.setState({
            editing_news: Object.assign({}, this.state.editing_news, {
                ...
                <div className="row">
                    <div className="col-sm-9">
                        ...
                        >
                            ...
                            {(this.state.is_admin ||
                                ...
                                <i
                                    className={
                                        editing ? "fa fa-save" : "fa fa-pencil"
                                    }
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-10">
                                    ...
                                    <div className="pad">
                                        {((!editing && group.hide_details) ||
                                            null) && (
                                            <i>
                                                {_("Group details are hidden")}
                                            </i>
                                        )}
                                        {(editing || null) && (
                                            <div>
                            ...
                            {!editing ? (
                                ...
                                <textarea
                                    ...
                                    placeholder={
                                        _(
                                            "Description",
                                        ) /* translators: Description of the group */
                                    }
                                />
                            )}
                            {(editing || null) && (
                        ...
                        {((group.is_public && !group.hide_details) ||
                            group.is_member ||
                            null) && (
                            <EmbeddedChatCard
                    ...
                    <div className="col-sm-3">
                        ...
                        <Card style={{ minHeight: "12rem" }}>
                            {this.state.is_admin && (
                                <div className="invite-input">
                                    ...
                                    >
                                        <PlayerAutocomplete
                                            onComplete={this.setUserToInvite}
                                        />
                                        <button
                        ...
                        {((group.invitation_requests &&
                            group.invitation_requests.length > 0) ||
                            null) && (
                            <Card className="invitation-requests">
                                ...
                                {group.invitation_requests.map((ir) => {
                                    const accept = () => {
                                        group.invitation_requests =
                                            group.invitation_requests.filter(
                                                (x) => x.id !== ir.id,
                                            );
                                        this.setState({
                        ...
                        <Card className="ladders">
                            <div>
                                <Link to={`/ladder/${group.ladder_ids[0]}`}>
                                    {_("9x9 Ladder")}
                                </Link>
                            </div>
                            <div>
        ...
        if (this.isAdmin(player_id)) {
            return (
                <div className="actions">
                    <button
                        className="reject sm"
                        onClick={() => this.unAdmin(player_id)}
                    >
                        {_("Un-Admin")}
                    </button>
                </div>
            ...
            return (
                <div className="actions">
                    ...
                    <button
                        className="reject sm"
                        onClick={() => this.makeAdmin(player_id)}
                    >
                        {_("Make Admin")}
                    </button>
                </div>
