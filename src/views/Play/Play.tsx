...
export class Play extends React.Component<{}, PlayState> {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            show_unranked_challenges: preferences.get(
            ...
            show_other_boardsize_challenges: preferences.get(
                "show-other-boardsize-challenges",
            ),
            automatch_size_options: data.get("automatch.size_options", [
                "19x19",
            ]),
    ...
    findMatch = (speed: "blitz" | "live" | "correspondence") => {
        ...
        const preferences: AutomatchPreferences = {
            uuid: uuid(),
            size_speed_options: this.state.automatch_size_options.map(
                (size) => {
                    return {
                        size: size,
                        speed: speed,
    ...
    cancelActiveAutomatch = () => {
        if (automatch_manager.active_live_automatcher) {
            automatch_manager.cancel(
                automatch_manager.active_live_automatcher.uuid,
            );
        }
        this.forceUpdate();
    };
    ...
    toggleShowUnrankedChallenges = () => {
        preferences.set(
            "show-unranked-challenges",
            !this.state.show_unranked_challenges,
        );
        this.setState({
            show_unranked_challenges: !this.state.show_unranked_challenges,
        });
    };
    ...
    toggleShowRankedChallenges = () => {
        preferences.set(
            ...
            !this.state.show_ranked_challenges,
        );
        this.setState({
            show_ranked_challenges: !this.state.show_ranked_challenges,
        });
    };
    ...
    toggleShow19x19Challenges = () => {
        preferences.set(
            ...
            !this.state.show_19x19_challenges,
        );
        this.setState({
            show_19x19_challenges: !this.state.show_19x19_challenges,
        });
    };
    ...
    toggleShow13x13Challenges = () => {
        preferences.set(
            ...
            !this.state.show_13x13_challenges,
        );
        this.setState({
            show_13x13_challenges: !this.state.show_13x13_challenges,
        });
    };
    ...
    toggleShowOtherBoardsizeChallenges = () => {
        ...
        this.setState({
            show_other_boardsize_challenges:
                !this.state.show_other_boardsize_challenges,
        });
    };

    anyChallengesToShow = (live) => {
        const challengeList = live
            ? this.state.live_list
            : this.state.correspondence_list;

        return (
            (this.state.show_all_challenges && challengeList.length) ||
            challengeList.reduce((prev, current) => {
    ...
    render() {
        ...
        const corr_automatchers = corr_automatcher_uuids.map(
            (uuid) =>
                automatch_manager.active_correspondence_automatchers[uuid],
        );
        ...
        return (
            <div className="Play container">
                        ...
                        >
                            ...
                            {corr_automatchers.map((m) => (
                                ...
                                >
                                    ...
                                    <span
                                        className={
                                            m.time_control.condition + " cell"
                                        }
                                    >
                                        {m.time_control.condition ===
                                        "no-preference"
                                            ? pgettext(
                                    ...
                                    <span
                                        className={
                                            m.handicap.condition + " cell"
                                        }
                                    >
                                        {m.handicap.condition ===
                                        "no-preference"
                                            ? pgettext(
                                                  "Automatch: no preference",
                                                  "No preference",
                                    ...
                                    <span
                                        className={m.rules.condition + " cell"}
                                    >
                            ...
                            {this.anyChallengesToShow(false)
                                ? this.challengeListHeaders()
                                : null}
                ...
                <div className="showall-selector">
                    ...
                    />
                    <label htmlFor="show-all-challenges">
                        {_("Show ineligible challenges")}
                    </label>
                    <br></br>
                    <input
                    ...
                    />
                    <label htmlFor="show-ranked-challenges">
                        {_("Ranked")}
                    </label>
                    <input
                    ...
                    />
                    <label htmlFor="show-unranked-challenges">
                        {_("Unranked")}
                    </label>
                    <br></br>
                    <input
                    ...
                    />
                    <label htmlFor="show-other-boardsize-challenges">
                        {_("Other boardsizes")}
                    </label>
                </div>
            </div>
            ...
            return (
                <div className="automatch-container">
                    ...
                    <div className="automatch-settings">
                        <button
                            className="danger sm"
                            onClick={this.cancelActiveAutomatch}
                        >
            ...
            return (
                <div className="automatch-container">
                    ...
                    <div className="automatch-settings">
                        <button
                            className="danger sm"
                            onClick={this.cancelActiveLiveChallenges}
                        >
            ...
            return (
                <div className="automatch-container">
                    ...
                    <div className="automatch-row-container">
                        <button
                            className="primary"
                            onClick={this.dismissCorrespondenceSpinner}
                        >
                            {_(
                                pgettext(
                ...
                <div className="automatch-container">
                    <div className="automatch-header">
                        ...
                        <div className="btn-group">
                            <button
                                className={
                                    size_enabled("9x9") ? "primary sm" : "sm"
                                }
                            ...
                            <button
                                className={
                                    size_enabled("13x13") ? "primary sm" : "sm"
                                }
                            ...
                            <button
                                className={
                                    size_enabled("19x19") ? "primary sm" : "sm"
                                }
    ...
    challengeList(isLive: boolean) {
        ...
        const timeControlClassName = (config) => {
            const isBold =
                isLive &&
                (config.time_per_move > 3600 || config.time_per_move === 0);
                ...
                <div className="ineligible">
                    {
                        this.state.show_all_challenges
                            ? _(
                                  "(none)",
                              ) /* translators: No challenges available */
                            : _(
                                  "(none available)",
                              ) /* translators: No challenges available */
                    }
        ...
        return challengeList.map((C) =>
            ...
            ((this.state.show_19x19_challenges &&
                ...
                (this.state.show_13x13_challenges &&
                    C.width === 13 &&
                    C.height === 13) ||
                (this.state.show_9x9_challenges &&
                    C.width === 9 &&
                    C.height === 9) ||
                (this.state.show_other_boardsize_challenges &&
                    (C.width !== C.height ||
                ...
                <div key={C.challenge_id} className="challenge-row">
                    <span className="cell" style={{ textAlign: "center" }}>
                            ...
                            (((C.eligible || C.user_challenge) &&
                                ...
                                <React.Fragment>
                                    ...
                                    <p className="cheat-alert-tooltiptext">
                                        {(C.komi !== null
                                            ? pgettext(
                                                  "Warning for users accepting game",
                                                  "Custom komi",
                                              ) +
                                              ": " +
                                              C.komi +
                        ...
                        {(((!C.eligible || C.removed) && !C.user_challenge) ||
                            null) && (
                            <span
                                className="ineligible"
                                title={C.ineligible_reason}
                            >
                                {_("Can't accept")}
                            </span>
                        )}
