...
export const routes = (
    <Router history={browserHistory}>
        <Main>
            ...
            */}
                <Route
                    path="/library/:player_id/:collection_id"
                    component={LibraryPlayer}
                />
                ...
                <Route
                    path="/tournaments/"
                    component={TournamentListMainView}
                />
                <Route
                ...
                <Route
                    ...
                    component={PuzzleCollectionList}
                />
                <Route
                    path="/puzzle-collection/:collection_id"
                    component={PuzzleCollection}
                />
            ...
            */}
                ...
                <Route
                    path="/learning-hub/:section/:page"
                ...
                <Route
                    path="/crash-course-learn-to-play-go/:step"
                    component={Tutorial}
                />
                <Route
                    path="/crash-course-learn-to-play-go"
                    component={Tutorial}
                />
                <Route
                ...
                />
                <Route
                    path="/docs/crash-course-learn-to-play-go"
                    component={Tutorial}
                />
                ...
                <Route
                    ...
                    component={docs.PrivacyPolicy}
                />
                <Route
                    path="/docs/terms-of-service"
                    component={docs.TermsOfService}
                />
                <Route
                    path="/docs/contact-information"
                    component={docs.ContactInformation}
                />
                <Route
                    path="/docs/refund-policy"
                    component={docs.RefundPolicy}
                />
                <Route
                    path="/docs/go-rules-comparison-matrix"
                    component={docs.RulesMatrix}
                />
                <Route path="/docs/team" component={docs.Team} />
                <Route
                    path="/docs/other-go-resources"
                    component={docs.GoResources}
                />
