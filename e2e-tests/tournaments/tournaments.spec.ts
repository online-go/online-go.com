...
import { tournamentNoVacationTest } from "./tournament-no-vacation";
...
ogsTest.describe("@Tournament Tests", () => {
    ...
    ogsTest(
        "No-vacation tournament shows banner and warning in vacation settings",
        tournamentNoVacationTest,
    );
});
