...
export default defineConfig({
    ...
    // CI/smoke: 60s is plenty for smoke tests that should complete quickly
    // Dev/E2E: 180s for longer-running full suite tests; @Slow tests override with test.setTimeout()
